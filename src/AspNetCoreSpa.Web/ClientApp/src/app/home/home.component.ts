 ...
 public banners:Banner[];
  ...
  private appendScriptCountDown() {
      ...
      this.hotestTours.forEach((tour) =>{
        ...
        `;
          this._renderer2.appendChild(this._document.getElementById("parent_hotest_"+tour.id), script); 
      });
      ...
      this.newestTours.forEach( (tour) =>{
        ...
        `;
          this._renderer2.appendChild(this._document.getElementById("parent_newest_"+tour.id), script);
      });
  }
    ...
    data.subscribe((result)=>{
      ...
      result.body.forEach( (d) =>{
          hotestTours.push({
            ...
            touristTypeId:d.tours[0].touristTypeId,
        });
      });
